...
import { FOOTER_CONTENT } from "@/innhold/navigasjon/footer";
      ...
      >
        {compact && (
          <div className="flex items-center justify-start gap-8 overflow-x-auto scrollbar-hide">
            {FOOTER_CONTENT.sections.map((section, idx) => (
              <div
                key={section.title}
                className={cn(
                  idx < FOOTER_CONTENT.sections.length - 1 &&
