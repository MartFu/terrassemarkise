...
export default function SolutionsSectionV2({ title, slides }: Props) {
    ...
    <Section spacing="md">
      <Container>
        ...
        <h2 className="text-center text-3xl md:text-4xl lg:text-6xl font-light tracking-tight leading-tight mb-16">
          Gi fasaden rett uttrykk med <br />
          riktig terrassemarkise
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div>
            ...
            <div className="flex items-baseline gap-4 mb-5">
              ...
              <span className="text-[0.6rem] font-mono tracking-widest uppercase text-foreground">
                {slide.type}
              </span>
            </div>
            ...
            <h3 className="text-xl md:text-2xl font-light tracking-tight leading-snug mb-5">
              <span className="text-muted-foreground">
                {slide.model} <span className="font-bold">// </span>
              </span>
